...
;; with-kw (8)
(define kw-map (hash
  'blame-add-context  (cons "责备-添加-上下文" (hash '#:important "重要" '#:swap? "交换?"))
  'build-chaperone-contract-property  (cons "构建-监护-契约-属性" (hash '#:collapsible-late-neg-projection "可折叠-后期-否定-投影" '#:equivalent "等价" '#:exercise "练习" '#:first-order "一阶" '#:generate "生成" '#:late-neg-projection "后期-否定-投影" '#:list-contract? "列表-契约?" '#:name "名称" '#:projection "投影" '#:stronger "更强" '#:val-first-projection "值-优先-投影"))
  'build-contract-property  (cons "构建-契约-属性" (hash '#:collapsible-late-neg-projection "可折叠-后期-否定-投影" '#:equivalent "等价" '#:exercise "练习" '#:first-order "一阶" '#:generate "生成" '#:late-neg-projection "后期-否定-投影" '#:list-contract? "列表-契约?" '#:name "名称" '#:projection "投影" '#:stronger "更强" '#:trusted "可信" '#:val-first-projection "值-优先-投影"))
  'build-flat-contract-property  (cons "构建-平坦-契约-属性" (hash '#:collapsible-late-neg-projection "可折叠-后期-否定-投影" '#:equivalent "等价" '#:first-order "一阶" '#:generate "生成" '#:late-neg-projection "后期-否定-投影" '#:list-contract? "列表-契约?" '#:name "名称" '#:projection "投影" '#:stronger "更强" '#:val-first-projection "值-优先-投影"))
  'make-chaperone-contract  (cons "创建-监护-契约" (hash '#:collapsible-late-neg-projection "可折叠-后期-否定-投影" '#:equivalent "等价" '#:first-order "一阶" '#:late-neg-projection "后期-否定-投影" '#:list-contract? "列表-契约?" '#:name "名称" '#:projection "投影" '#:stronger "更强" '#:val-first-projection "值-优先-投影"))
  'make-contract  (cons "创建-契约" (hash '#:collapsible-late-neg-projection "可折叠-后期-否定-投影" '#:equivalent "等价" '#:exercise "练习" '#:first-order "一阶" '#:generate "生成" '#:late-neg-projection "后期-否定-投影" '#:list-contract? "列表-契约?" '#:name "名称" '#:projection "投影" '#:stronger "更强" '#:val-first-projection "值-优先-投影"))
  'make-flat-contract  (cons "创建-平坦-契约" (hash '#:collapsible-late-neg-projection "可折叠-后期-否定-投影" '#:equivalent "等价" '#:first-order "一阶" '#:late-neg-projection "后期-否定-投影" '#:list-contract? "列表-契约?" '#:name "名称" '#:projection "投影" '#:stronger "更强" '#:val-first-projection "值-优先-投影"))
  'raise-blame-error  (cons "引发-责备-错误" (hash '#:missing-party "缺失-方"))
))
